...
public class WorthSeeingSideMenu extends Menu {
    ...
    @io.qase.api.annotation.Step("Click the \"Litania do Pani Uśmiechniętej\" link")
    ...
    @io.qase.api.annotation.Step("Click the \"Regulamin cmentarza\" link")
    ...
    @io.qase.api.annotation.Step("Click the \"Delegat ds. ochrony dzieci i młodzieży\" link")
    ...
    @io.qase.api.annotation.Step("Click the \"Archidiecezja Katowicka\" link")
    ...
    @io.qase.api.annotation.Step("Click the \"Czytania liturgiczne\" link")
